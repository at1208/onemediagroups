    ...
    <div className={classes.root}>
      ...
      >
        <div className={classes.toolbar}>
          ...
          {!matches && (
            <IconButton onClick={handleDrawerClose}>
              {theme.direction === "rtl" ? (
                <ChevronRightIcon className={classes.direc} />
              ) : (
                <ChevronLeftIcon className={classes.direc} />
              )}
            </IconButton>
          )}
            ...
            <Grid item xs>
              <Grid container justify="center" wrap="wrap">
                <Grid item>
                  <Box pt={6}>
                    <Avatar
                      name={isAuth() && isAuth().full_name}
                      src={isAuth() && isAuth().headshot_url}
                      size={37}
                      textSize={15}
                    />
                  </Box>
        ...
        <List className={classes.list}>
          ...
          {(checkVisiblityOnSidebar("my_tasks") ||
            checkVisiblityOnSidebar("task")) && (
            <ListItem button onClick={handleChange("task")} className="mt-3">
              ...
              <ListItemText>
                <Typography className={classes.menutext}>Tasks</Typography>
              </ListItemText>
              {openTaskCollapse ? (
          ...
          {checkVisiblityOnSidebar("channel") && (
            <Link to="/channels">
          ...
          {(checkVisiblityOnSidebar("all_employees") ||
            checkVisiblityOnSidebar("department") ||
            checkVisiblityOnSidebar("designation")) && (
            <ListItem
              button
            ...
            >
              ...
              <ListItemText>
                <Typography className={classes.menutext}>Employees</Typography>
              </ListItemText>
          ...
          {(checkVisiblityOnSidebar("write_blog") ||
            checkVisiblityOnSidebar("all_blogs") ||
            checkVisiblityOnSidebar("domain") ||
            checkVisiblityOnSidebar("category")) && (
            <ListItem button onClick={handleChange("content")} className="mt-3">
              ...
              <ListItemText>
                <Typography className={classes.menutext}>Content</Typography>
              </ListItemText>
              {openContentCollapse ? (
                <ExpandLess className={classes.direc} />
              ) : (
          ...
          <Collapse in={openContentCollapse} timeout="auto" unmountOnExit>
            <List
              ...
              className={classes.collapseList}
            >
              {checkVisiblityOnSidebar("my_blogs") && (
                <Link to="/my-blogs">
          ...
          {checkVisiblityOnSidebar("contact") && (
            <Link to="/contact">
          ...
          {checkVisiblityOnSidebar("activity") && (
            <Link to="/activities">
