...
const EditEmployee = ({ editEmployee }) => {
  ...
  const role = [{ title: "EMPLOYEE" }, { title: "ADMIN" }];
          ...
          <Grid container spacing={3} justify="center">
            <Grid item xs={12} md={9}>
              <Card className={classes.cardRoot}>
                {employee.success && (
                  <Alert severity="success">{employee.success}</Alert>
                )}
                {employee.error && (
                  <Alert severity="error">{employee.error}</Alert>
                )}
                <br />
                ...
                <Grid item xs={12} md={12}>
                  <ModulePermission
                    onChangePermission={(data) =>
                      setEmployee({ ...employee, permission: data })
                    }
                    permission={editEmployee.permission}
                  />
                </Grid>
            ...
            <Grid item md={2}>
              ...
              <ModuleVisibility
                onChangeVisibility={(data) =>
                  setEmployee({ ...employee, module_visibility: data })
                }
